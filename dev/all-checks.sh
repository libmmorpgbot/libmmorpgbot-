...
PURE=(reachable bundle protocol request-shape bookpool prodfix heal skillbuff petskill teleport runes playerlog netsize death-drop spawn farmhigh farmseason)
