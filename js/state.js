...
let petSkillTimer = 0;
let petSkillId = null;
// Когда питомец применит навык в следующий раз (метка времени, не остаток).
// Остаток пересчитывается на кадре — так кружок в углу переживает и паузу
// приложения, и любой пропущенный кадр, чего накопитель не пережил бы.
// 0 — «фаза неизвестна»: до первого 'petSkillCd'/'petSkill' с сервера.
let petSkillNextAt = 0;
