...
function updateJoyCenter() { _joyCenter.x = W * 0.30; _joyCenter.y = H - NAV_H - 112; }
...
function getTargetBtnPos() {
  ...
  if (f) {
    ...
    return { x: pot.x - 62, y: pot.y + 20, r: 25 };
  }
