...
Object.assign(I18N_UI, {
  ...
  friendshipDesc: { ru: 'Награда за друзей, которых вы пригласили и которые дошли до {lvl} уровня. Считаются только друзья, присоединившиеся после появления этой награды. Каждый тир можно забрать один раз.', en: 'A reward for friends you invited who reached level {lvl}. Only friends who joined after this reward appeared count. Each tier can be claimed once.', uk: 'Нагорода за друзів, яких ви запросили і які досягли {lvl} рівня. Рахуються лише друзі, що приєдналися після появи цієї нагороди. Кожен тир можна забрати один раз.', es: 'Una recompensa por los amigos que invitaste y que alcanzaron el nivel {lvl}. Solo cuentan los amigos que se unieron después de que apareciera esta recompensa. Cada nivel se puede reclamar una vez.', tr: 'Davet ettiğiniz ve {lvl}. seviyeye ulaşan arkadaşlarınız için bir ödül. Yalnızca bu ödül ortaya çıktıktan sonra katılan arkadaşlar sayılır. Her kademe bir kez alınabilir.', pt: 'Uma recompensa pelos amigos que você convidou e que chegaram ao nível {lvl}. Só contam os amigos que entraram depois que essa recompensa apareceu. Cada nível pode ser resgatado uma vez.' },
