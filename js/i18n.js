...
Object.assign(I18N_UI, {
  ...
  // ── заимствованная способность (джекпот переработки легендарной руны) ────
  borrowedSkillBadge: { ru: 'Чужая', en: 'Borrowed', uk: 'Чужа', es: 'Prestada', tr: 'Ödünç', pt: 'Emprestada' },
  foreignSkillAvailableHdr: { ru: 'Доступна книга другого класса', en: 'A book of another class is available', uk: 'Доступна книга іншого класу', es: 'Hay un libro de otra clase disponible', tr: 'Başka bir sınıfın kitabı mevcut', pt: 'Um livro de outra classe está disponível' },
  learnForeignBtnFmt: { ru: 'Изучить: {name}', en: 'Learn: {name}', uk: 'Вивчити: {name}', es: 'Aprender: {name}', tr: 'Öğren: {name}', pt: 'Aprender: {name}' },
  revertSkillBtn: { ru: 'Вернуть свою способность', en: 'Revert to own skill', uk: 'Повернути свою здібність', es: 'Volver a la habilidad propia', tr: 'Kendi yeteneğine dön', pt: 'Voltar à habilidade própria' },
  learnForeignSkillConfirmFmt: { ru: 'Изучить «{name}» в слот {key}? Уровень слота сбросится до 1, вторая профессия этого слота будет снята.', en: 'Learn "{name}" into slot {key}? The slot\'s level resets to 1 and its advanced skill is unlearned.', uk: 'Вивчити «{name}» у слот {key}? Рівень слота скинеться до 1, друга професія цього слота знімається.', es: '¿Aprender "{name}" en la ranura {key}? El nivel de la ranura se reinicia a 1 y se pierde su habilidad avanzada.', tr: '"{name}" {key} yuvasına öğrenilsin mi? Yuvanın seviyesi 1\'e sıfırlanır ve ikinci meslek kitabı kaybolur.', pt: 'Aprender "{name}" no slot {key}? O nível do slot volta a 1 e sua habilidade avançada é perdida.' },
  revertSkillConfirmFmt: { ru: 'Вернуть свою способность в слот {key}? Уровень слота сбросится до 1, вторая профессия этого слота будет снята.', en: 'Revert slot {key} to your own class\'s skill? The slot\'s level resets to 1 and its advanced skill is unlearned.', uk: 'Повернути свою здібність у слот {key}? Рівень слота скинеться до 1, друга професія цього слота знімається.', es: '¿Volver a la habilidad propia en la ranura {key}? El nivel de la ranura se reinicia a 1 y se pierde su habilidad avanzada.', tr: '{key} yuvası kendi sınıfının yeteneğine döndürülsün mü? Yuvanın seviyesi 1\'e sıfırlanır ve ikinci meslek kitabı kaybolur.', pt: 'Voltar o slot {key} para a habilidade da sua própria classe? O nível do slot volta a 1 e sua habilidade avançada é perdida.' },
