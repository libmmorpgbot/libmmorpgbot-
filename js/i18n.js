...
const I18N_UI = {
  ...
  tournamentTab:        { ru: 'Турнир', en: 'Tournament', uk: 'Турнір', es: 'Torneo', tr: 'Turnuva', pt: 'Torneio' },
  eventSubTournament:   { ru: 'Турнир на 32 участника, на вылет', en: '32-player knockout tournament', uk: 'Турнір на 32 учасники, на виліт', es: 'Torneo de 32 participantes, eliminación directa', tr: '32 kişilik eleme turnuvası', pt: 'Torneio de 32 participantes, eliminatória' },
  eventSchedTournament: { ru: 'Чт и Вс в 23:00 МСК', en: 'Thu & Sun at 23:00 MSK', uk: 'Чт і Нд о 23:00 МСК', es: 'Jue y dom a las 23:00 (hora de Moscú)', tr: 'Per ve Paz 23:00 Moskova saatiyle', pt: 'Qui e Dom às 23h00 (horário de Moscou)' },
  trArenaLbl:           { ru: 'Ринг турнира', en: 'Tournament ring', uk: 'Ринг турніру', es: 'Ring del torneo', tr: 'Turnuva ringi', pt: 'Ringue do torneio' },
  trPhaseIdle:          { ru: 'До регистрации на турнир', en: 'Tournament registration opens in', uk: 'До реєстрації на турнір', es: 'Hasta la inscripción al torneo', tr: 'Turnuva kaydına kalan süre', pt: 'Até a inscrição no torneio' },
  trPhaseQueued:        { ru: 'Вы записаны, ждём остальных', en: "You're signed up, waiting for others", uk: 'Ви записані, чекаємо інших', es: 'Estás inscrito, esperando a los demás', tr: 'Kayıt oldun, diğerleri bekleniyor', pt: 'Você está inscrito, aguardando os outros' },
  trPhaseFighting:      { ru: 'Бой идёт', en: 'Match in progress', uk: 'Бій триває', es: 'Combate en curso', tr: 'Maç sürüyor', pt: 'Partida em andamento' },
  trPhaseWaiting:       { ru: 'Вы прошли дальше — ждите следующий раунд', en: 'You advanced — wait for the next round', uk: 'Ви пройшли далі — чекайте наступний раунд', es: 'Avanzaste — espera la siguiente ronda', tr: 'İlerledin — bir sonraki turu bekle', pt: 'Você avançou — aguarde a próxima rodada' },
  trNeedLevelFmt:       { ru: 'Нужен {n} уровень', en: 'Requires level {n}', uk: 'Потрібен {n} рівень', es: 'Requiere nivel {n}', tr: '{n}. seviye gerekli', pt: 'Requer nível {n}' },
  trCountFmt:           { ru: '{n}/{need}', en: '{n}/{need}', uk: '{n}/{need}', es: '{n}/{need}', tr: '{n}/{need}', pt: '{n}/{need}' },
  trRoundFmt:           { ru: 'Раунд {n} из {total}', en: 'Round {n} of {total}', uk: 'Раунд {n} з {total}', es: 'Ronda {n} de {total}', tr: '{total} turdan {n}.', pt: 'Rodada {n} de {total}' },
  trOpponentFmt:        { ru: 'Соперник: {name}', en: 'Opponent: {name}', uk: 'Суперник: {name}', es: 'Rival: {name}', tr: 'Rakip: {name}', pt: 'Adversário: {name}' },
  trWonRoundMsg:        { ru: '✅ Победа в раунде! Ждите следующий', en: '✅ Round won! Wait for the next one', uk: '✅ Перемога в раунді! Чекайте наступний', es: '✅ ¡Ronda ganada! Espera la siguiente', tr: '✅ Turu kazandın! Bir sonrakini bekle', pt: '✅ Rodada vencida! Aguarde a próxima' },
  trEliminatedMsg:      { ru: '💀 Вы выбыли из турнира', en: '💀 You are out of the tournament', uk: '💀 Ви вибули з турніру', es: '💀 Has quedado eliminado del torneo', tr: '💀 Turnuvadan elendin', pt: '💀 Você foi eliminado do torneio' },
  trChampionMsg:        { ru: '🏆 Вы — ЧЕМПИОН ТУРНИРА!', en: '🏆 You are the TOURNAMENT CHAMPION!', uk: '🏆 Ви — ЧЕМПІОН ТУРНІРУ!', es: '🏆 ¡Eres el CAMPEÓN DEL TORNEO!', tr: '🏆 TURNUVA ŞAMPİYONUSUN!', pt: '🏆 Você é o CAMPEÃO DO TORNEIO!' },
  trRunnerUpMsg:        { ru: 'Финал турнира: вы заняли 2-е место', en: 'Tournament final: you finished 2nd', uk: 'Фінал турніру: ви посіли 2-е місце', es: 'Final del torneo: quedaste en 2.º lugar', tr: 'Turnuva finali: 2. oldun', pt: 'Final do torneio: você ficou em 2º lugar' },
  trRule1:              { ru: 'Регистрация — по четвергам и воскресеньям в 23:00 по Москве, ровно 32 участника', en: 'Registration — Thursdays and Sundays at 23:00 Moscow time, exactly 32 participants', uk: 'Реєстрація — по четвергах і неділях о 23:00 за Москвою, рівно 32 учасники', es: 'Inscripción — jueves y domingos a las 23:00 (hora de Moscú), exactamente 32 participantes', tr: 'Kayıt — Perşembe ve Pazar günleri 23:00 Moskova saatiyle, tam 32 katılımcı', pt: 'Inscrição — quintas e domingos às 23h00 (horário de Moscou), exatamente 32 participantes' },
  trRule2:              { ru: 'Наберётся 32 человека — сетка стартует сразу, не дожидаясь конца окна', en: 'Once 32 people sign up, the bracket starts immediately, without waiting for the window to end', uk: 'Щойно набереться 32 людини — сітка стартує одразу, не чекаючи кінця вікна', es: 'En cuanto se inscriban 32 personas, el cuadro empieza de inmediato, sin esperar a que termine la ventana', tr: '32 kişi toplanınca kura beklemeden hemen başlar', pt: 'Assim que 32 pessoas se inscreverem, a chave começa imediatamente, sem esperar o fim da janela' },
  trRule3:              { ru: 'Проигрыш в первом бою не выбивает — даётся один шанс отыграться в нижней сетке', en: "Losing your first match doesn't eliminate you — you get one chance to fight back in the lower bracket", uk: 'Поразка в першому бою не вибиває — дається один шанс відігратися в нижній сітці', es: 'Perder el primer combate no te elimina — tienes una oportunidad de recuperarte en el cuadro inferior', tr: 'İlk maçı kaybetmek elemez — alt kademede bir şans daha verilir', pt: 'Perder a primeira luta não elimina — você tem uma chance de se recuperar na chave baixa' },
  trRule4:              { ru: 'Проигрыш в нижней сетке — выбывание из турнира', en: 'Losing in the lower bracket eliminates you from the tournament', uk: 'Поразка в нижній сітці — вибування з турніру', es: 'Perder en el cuadro inferior te elimina del torneo', tr: 'Alt kademede kaybetmek turnuvadan eler', pt: 'Perder na chave baixa elimina você do torneio' },
  trRule5:              { ru: 'Бой длится 1 минуту; если оба живы к концу — побеждает тот, кто нанёс больше урона', en: 'A fight lasts 1 minute; if both are still alive at the end, whoever dealt more damage wins', uk: 'Бій триває 1 хвилину; якщо обидва живі наприкінці — перемагає той, хто завдав більше шкоди', es: 'El combate dura 1 minuto; si ambos siguen vivos al final, gana quien haya causado más daño', tr: 'Dövüş 1 dakika sürer; sonunda ikisi de hayattaysa daha çok hasar veren kazanır', pt: 'A luta dura 1 minuto; se ambos ainda estiverem vivos no final, vence quem causou mais dano' },
  trRule6:              { ru: 'Следующий раунд начинается через 3 минуты после завершения всех боёв текущего', en: 'The next round starts 3 minutes after every fight in the current one has finished', uk: 'Наступний раунд починається через 3 хвилини після завершення всіх боїв поточного', es: 'La siguiente ronda empieza 3 minutos después de que terminen todos los combates de la actual', tr: 'Bir sonraki tur, mevcut turdaki tüm dövüşler bitince 3 dakika sonra başlar', pt: 'A próxima rodada começa 3 minutos após o fim de todas as lutas da atual' },
  trRule7:              { ru: 'Финал турнира решает всё сразу, без переигровки', en: 'The tournament final decides everything in one match, no replay', uk: 'Фінал турніру вирішує все одразу, без перегравання', es: 'La final del torneo lo decide todo de una vez, sin repetición', tr: 'Turnuva finali tek maçta biter, tekrar oynanmaz', pt: 'A final do torneio decide tudo de uma vez, sem revanche' },
  trRule8:              { ru: 'Награда: победа в раунде верхней сетки +10 Liberty, нижней — +5. Финал: +100 чемпиону, +50 финалисту', en: 'Reward: an upper-bracket round win is +10 Liberty, a lower-bracket one +5. Final: +100 to the champion, +50 to the runner-up', uk: 'Нагорода: перемога в раунді верхньої сітки +10 Liberty, нижньої — +5. Фінал: +100 чемпіону, +50 фіналісту', es: 'Recompensa: ganar una ronda del cuadro superior da +10 Liberty, del inferior +5. Final: +100 al campeón, +50 al subcampeón', tr: 'Ödül: üst kademe tur kazanımı +10 Liberty, alt kademe +5. Final: şampiyona +100, finaliste +50', pt: 'Recompensa: vencer uma rodada da chave alta dá +10 Liberty, da chave baixa +5. Final: +100 para o campeão, +50 para o vice' },
  tournamentHudBtn:     { ru: 'Турнир', en: 'Tournament', uk: 'Турнір', es: 'Torneo', tr: 'Turnuva', pt: 'Torneio' },
  tourTabReg:           { ru: 'Регистрация', en: 'Registration', uk: 'Реєстрація', es: 'Inscripción', tr: 'Kayıt', pt: 'Inscrição' },
  tourTabBracket:       { ru: 'Сетка', en: 'Bracket', uk: 'Сітка', es: 'Cuadro', tr: 'Kura', pt: 'Chave' },
  tourTabRating:        { ru: 'Рейтинг', en: 'Rating', uk: 'Рейтинг', es: 'Clasificación', tr: 'Sıralama', pt: 'Classificação' },
  // ── 3v3 arena ───────────────────────────────────────────────────────────
  ...
  seasonBurnHdr:  { ru: 'Сжигание книг:', en: 'Burning books:', uk: 'Спалювання книг:', es: 'Quemar libros:', tr: 'Kitap yakma:', pt: 'Queimar livros:' },
  ...
  coopTab: { ru: 'Сотрудничество', en: 'Coop', uk: 'Співпраця', es: 'Cooperativo', tr: 'İş birliği', pt: 'Cooperativo' },
  coopLbl: { ru: 'Сотрудничество', en: 'Coop', uk: 'Співпраця', es: 'Cooperativo', tr: 'İş birliği', pt: 'Cooperativo' },
  coopPhaseFighting: { ru: 'Этап {stage}/{max}', en: 'Stage {stage}/{max}', uk: 'Етап {stage}/{max}', es: 'Fase {stage}/{max}', tr: 'Aşama {stage}/{max}', pt: 'Fase {stage}/{max}' },
  coopPhaseReady: { ru: 'Приготовьтесь...', en: 'Get ready...', uk: 'Приготуйтеся...', es: 'Prepárate...', tr: 'Hazır ol...', pt: 'Prepare-se...' },
  coopPhaseLeaderLbl: { ru: 'Ваша группа', en: 'Your group', uk: 'Ваша група', es: 'Tu grupo', tr: 'Grubun', pt: 'Seu grupo' },
  coopPhaseMemberLbl: { ru: 'Вы в группе', en: 'In a group', uk: 'Ви в групі', es: 'En un grupo', tr: 'Bir gruptasın', pt: 'Em um grupo' },
  coopFreezeLbl: { ru: 'Монстры появятся через', en: 'Monsters arrive in', uk: 'Монстри з\'являться через', es: 'Los monstruos llegan en', tr: 'Canavarlar geliyor', pt: 'Monstros chegam em' },
  coopStageMsg: { ru: 'Этап {stage} из {max}', en: 'Stage {stage} of {max}', uk: 'Етап {stage} з {max}', es: 'Fase {stage} de {max}', tr: 'Aşama {stage}/{max}', pt: 'Fase {stage} de {max}' },
  coopWaitingPartnerMsg: { ru: 'Ваш коридор зачищен — ждём напарника', en: 'Your corridor is clear — waiting for your partner', uk: 'Ваш коридор зачищено — чекаємо напарника', es: 'Tu pasillo está despejado — esperando a tu compañero', tr: 'Koridorun temizlendi — ortağın bekleniyor', pt: 'Seu corredor está limpo — esperando seu parceiro' },
  coopBossSpawnedMsg: { ru: 'Оба зачистили! Появился босс', en: 'Both cleared! The boss has appeared', uk: 'Обидва зачистили! З\'явився бос', es: '¡Ambos despejaron! Apareció el jefe', tr: 'İkiniz de temizlediniz! Patron belirdi', pt: 'Ambos limparam! O chefe apareceu' },
  coopBossWonMsg: { ru: 'Босс повержен! Вам достались награда', en: 'Boss defeated! You got the reward', uk: 'Боса переможено! Нагорода дісталася вам', es: '¡Jefe derrotado! La recompensa es tuya', tr: 'Patron yenildi! Ödül senin', pt: 'Chefe derrotado! A recompensa é sua' },
  coopBossLostMsg: { ru: 'Босс повержен! Награда досталась напарнику', en: 'Boss defeated! Your partner got the reward', uk: 'Боса переможено! Нагорода дісталася напарнику', es: '¡Jefe derrotado! La recompensa fue para tu compañero', tr: 'Patron yenildi! Ödül ortağına gitti', pt: 'Chefe derrotado! A recompensa foi para seu parceiro' },
  coopClearedMsg: { ru: 'Подземелье пройдено!', en: 'Dungeon cleared!', uk: 'Підземелля пройдено!', es: '¡Mazmorra completada!', tr: 'Zindan tamamlandı!', pt: 'Masmorra concluída!' },
  coopDiedMsg: { ru: 'Забег прерван — кто-то из вас погиб', en: 'Run ended — one of you died', uk: 'Проходження перервано — хтось із вас загинув', es: 'Partida interrumpida — uno de los dos murió', tr: 'Zindan yarıda kaldı — biriniz öldü', pt: 'Partida interrompida — um de vocês morreu' },
  coopRule1: { ru: 'Создайте группу или войдите в чужую — начать забег может только лидер группы', en: 'Create a group or join someone else’s — only the group leader can start the run', uk: 'Створіть групу або приєднайтеся до чужої — розпочати проходження може лише лідер групи', es: 'Crea un grupo o únete al de otro — solo el líder del grupo puede empezar la partida', tr: 'Bir grup kur ya da başkasının grubuna katıl — zindanı yalnızca grup lideri başlatabilir', pt: 'Crie um grupo ou entre no de outro — só o líder do grupo pode começar a partida' },
  coopCreateGroupBtn: { ru: 'Создать группу', en: 'Create group', uk: 'Створити групу', es: 'Crear grupo', tr: 'Grup kur', pt: 'Criar grupo' },
  coopJoinBtn: { ru: 'Войти', en: 'Join', uk: 'Увійти', es: 'Entrar', tr: 'Katıl', pt: 'Entrar' },
  coopStartBtn: { ru: 'Начать', en: 'Start', uk: 'Почати', es: 'Empezar', tr: 'Başlat', pt: 'Começar' },
  coopKickBtn: { ru: 'Изгнать', en: 'Kick', uk: 'Виключити', es: 'Expulsar', tr: 'At', pt: 'Expulsar' },
  coopDisbandBtn: { ru: 'Расформировать группу', en: 'Disband group', uk: 'Розпустити групу', es: 'Disolver grupo', tr: 'Grubu dağıt', pt: 'Dissolver grupo' },
  coopLeaveGroupBtn: { ru: 'Покинуть группу', en: 'Leave group', uk: 'Покинути групу', es: 'Abandonar grupo', tr: 'Gruptan ayrıl', pt: 'Sair do grupo' },
  coopYouTag: { ru: 'вы', en: 'you', uk: 'ви', es: 'tú', tr: 'sen', pt: 'você' },
  coopLeaderTag: { ru: 'лидер', en: 'leader', uk: 'лідер', es: 'líder', tr: 'lider', pt: 'líder' },
  coopSlotOpenLbl: { ru: 'место свободно', en: 'slot open', uk: 'місце вільне', es: 'lugar libre', tr: 'yer boş', pt: 'vaga livre' },
  coopWaitingMemberLbl: { ru: 'Ждём участника...', en: 'Waiting for a member...', uk: 'Чекаємо учасника...', es: 'Esperando a alguien...', tr: 'Üye bekleniyor...', pt: 'Esperando um jogador...' },
  coopWaitingLeaderLbl: { ru: 'Ждём, когда лидер начнёт', en: 'Waiting for the leader to start', uk: 'Чекаємо, коли лідер почне', es: 'Esperando al líder', tr: 'Liderin başlatması bekleniyor', pt: 'Esperando o líder começar' },
  coopNoGroupsLbl: { ru: 'Открытых групп пока нет', en: 'No open groups yet', uk: 'Відкритих груп поки немає', es: 'Aún no hay grupos abiertos', tr: 'Henüz açık grup yok', pt: 'Ainda não há grupos abertos' },
  coopGroupKickedMsg: { ru: 'Лидер исключил вас из группы', en: 'The leader kicked you from the group', uk: 'Лідер виключив вас із групи', es: 'El líder te expulsó del grupo', tr: 'Lider seni gruptan attı', pt: 'O líder te expulsou do grupo' },
  coopGroupDissolvedMsg: { ru: 'Группа распущена', en: 'The group was disbanded', uk: 'Групу розпущено', es: 'El grupo se disolvió', tr: 'Grup dağıtıldı', pt: 'O grupo foi dissolvido' },
  coopRule2: { ru: '8 этапов по 40 монстров, уровень растёт: 10, 15, 20, 25, 30, 40, 50, 60', en: '8 stages of 40 monsters, level rising: 10, 15, 20, 25, 30, 40, 50, 60', uk: '8 етапів по 40 монстрів, рівень зростає: 10, 15, 20, 25, 30, 40, 50, 60', es: '8 fases de 40 monstruos, con el nivel subiendo: 10, 15, 20, 25, 30, 40, 50, 60', tr: '40 canavarlık 8 aşama, seviye artarak: 10, 15, 20, 25, 30, 40, 50, 60', pt: '8 fases de 40 monstros, com o nível subindo: 10, 15, 20, 25, 30, 40, 50, 60' },
  coopRule3: { ru: 'Следующий этап открывается, только когда оба игрока зачистят текущий', en: 'The next stage opens only once both players clear the current one', uk: 'Наступний етап відкривається лише тоді, коли обидва гравці зачистять поточний', es: 'La siguiente fase se abre solo cuando ambos jugadores despejan la actual', tr: 'Sonraki aşama, ancak iki oyuncu da mevcut aşamayı temizleyince açılır', pt: 'A próxima fase só abre quando os dois jogadores limparem a atual' },
  coopRule4: { ru: 'В конце — общий босс 40 уровня: 1 безопасный камень заточки и 100 Liberty одному случайному игроку', en: 'At the end — a shared level-40 boss: 1 safe enchant stone and 100 Liberty to one random player', uk: 'У кінці — спільний бос 40 рівня: 1 безпечний камінь гартування і 100 Liberty одному випадковому гравцю', es: 'Al final, un jefe compartido de nivel 40: 1 piedra de encantamiento segura y 100 Liberty para un jugador al azar', tr: 'Sonda ortak bir seviye 40 patron: rastgele bir oyuncuya 1 güvenli büyü taşı ve 100 Liberty', pt: 'No fim — um chefe compartilhado de nível 40: 1 pedra de encantamento segura e 100 Liberty para um jogador aleatório' },
  coopRule5: { ru: 'Смерть любого из двоих завершает забег для обоих', en: "Either player's death ends the run for both", uk: 'Смерть будь-кого з двох завершує проходження для обох', es: 'La muerte de cualquiera de los dos termina la partida para ambos', tr: 'İkinizden birinin ölmesi zindanı ikiniz için de bitirir', pt: 'A morte de qualquer um dos dois encerra a partida para ambos' },

  farm2Tab: { ru: 'Элитная фарм-зона', en: 'Elite Farm Zone', uk: 'Елітна фарм-зона', es: 'Zona de farmeo élite', tr: 'Elit farm bölgesi', pt: 'Zona de farm elite' },
  eventSubFarm2: { ru: 'Группа из 3', en: 'Party of 3', uk: 'Група з 3', es: 'Grupo de 3', tr: '3 kişilik grup', pt: 'Grupo de 3' },
  eventSchedFarm2: { ru: '120 мин/день', en: '120 min/day', uk: '120 хв/день', es: '120 min/día', tr: 'Günde 120 dk', pt: '120 min/dia' },
  farm2Lbl: { ru: 'Элитная фарм-зона', en: 'Elite Farm Zone', uk: 'Елітна фарм-зона', es: 'Zona de farmeo élite', tr: 'Elit farm bölgesi', pt: 'Zona de farm elite' },
  farm2NoTimeLbl: { ru: 'Время на сегодня закончилось', en: 'Out of time for today', uk: 'Час на сьогодні вичерпано', es: 'Se acabó el tiempo de hoy', tr: 'Bugünlük süren doldu', pt: 'Acabou o tempo de hoje' },
  farm2MinutesFmt: { ru: '{n}/{max} мин', en: '{n}/{max} min', uk: '{n}/{max} хв', es: '{n}/{max} min', tr: '{n}/{max} dk', pt: '{n}/{max} min' },
  farm2GroupKickedMsg: { ru: 'Лидер исключил вас из группы', en: 'The leader kicked you from the group', uk: 'Лідер виключив вас із групи', es: 'El líder te expulsó del grupo', tr: 'Lider seni gruptan attı', pt: 'O líder te expulsou do grupo' },
  farm2GroupDissolvedMsg: { ru: 'Группа распущена', en: 'The group was disbanded', uk: 'Групу розпущено', es: 'El grupo se disolvió', tr: 'Grup dağıtıldı', pt: 'O grupo foi dissolvido' },
  farm2TimeCapMsg: { ru: 'Дневной лимит времени в зоне исчерпан', en: "You've hit today's time limit in the zone", uk: 'Денний ліміт часу в зоні вичерпано', es: 'Has agotado tu límite diario de tiempo en la zona', tr: 'Bölgedeki günlük süre sınırına ulaştın', pt: 'Você atingiu o limite diário de tempo na zona' },
  farm2PartyBrokenMsg: { ru: 'В зоне осталось меньше 3 человек из группы — все выведены', en: 'Fewer than 3 of the party are still in the zone — everyone was pulled out', uk: 'У зоні лишилося менше 3 учасників групи — усіх виведено', es: 'Quedan menos de 3 del grupo en la zona — se saca a todos', tr: 'Bölgede gruptan 3 kişiden az kaldı — herkes dışarı çıkarıldı', pt: 'Restam menos de 3 do grupo na zona — todos foram retirados' },
  farm2Rule1: { ru: 'Вход с {n} уровня, только полной группой из 3 человек', en: 'Entry from level {n}, only as a full party of 3', uk: 'Вхід з {n} рівня, лише повною групою з 3 осіб', es: 'Entrada desde el nivel {n}, solo con un grupo completo de 3', tr: '{n}. seviyeden itibaren giriş, yalnızca 3 kişilik tam grupla', pt: 'Entrada a partir do nível {n}, só com grupo completo de 3' },
  farm2Rule2: { ru: 'Войти в зону может только лидер группы — он затягивает за собой остальных участников (группа из {n} человек)', en: 'Only the group leader can start the run — everyone else is pulled in with them (a party of {n})', uk: 'Увійти в зону може лише лідер групи — він затягує за собою решту учасників (група з {n} осіб)', es: 'Solo el líder del grupo puede entrar en la zona — arrastra consigo al resto de los miembros (grupo de {n})', tr: 'Bölgeye yalnızca grup lideri girebilir — diğer üyeleri de peşinden çeker ({n} kişilik grup)', pt: 'Só o líder do grupo pode entrar na zona — ele puxa os demais membros junto (grupo de {n})' },
  farm2Rule3: { ru: 'Если в зоне останется меньше 3 человек группы, всех выводит из зоны', en: 'If fewer than 3 of the party are still in the zone, everyone is pulled out', uk: 'Якщо в зоні лишиться менше 3 учасників групи, усіх виводить із зони', es: 'Si quedan menos de 3 del grupo en la zona, se saca a todos', tr: 'Bölgede gruptan 3 kişiden azı kalırsa herkes dışarı çıkarılır', pt: 'Se restarem menos de 3 do grupo na zona, todos são retirados' },
  farm2Rule4: { ru: '2 комнаты по 50 монстров, сильнее обычных и вдвое быстрее — стоят пачками по 4, сами не нападают, но удар по одному будит всю пачку', en: '2 rooms of 50 monsters each, stronger than ordinary ones and twice as fast — standing in packs of 4, they never attack first, but hitting one wakes the whole pack', uk: '2 кімнати по 50 монстрів, сильніші за звичайних і вдвічі швидші — стоять зграями по 4, самі не нападають, але удар по одному будить усю зграю', es: '2 salas de 50 monstruos, más fuertes de lo normal y el doble de rápidos — están en manadas de 4, nunca atacan primero, pero golpear a uno despierta a toda la manada', tr: 'Her biri 50 canavarlık 2 oda; normalden güçlü ve iki kat hızlılar — 4\'erli sürüler halinde dururlar, kendileri saldırmaz ama birine vurmak tüm sürüyü uyandırır', pt: '2 salas de 50 monstros, mais fortes que os comuns e duas vezes mais rápidos — ficam em bandos de 4, nunca atacam primeiro, mas bater em um acorda o bando inteiro' },
  farm2Rule5: { ru: 'Не более {n} минут в зоне на игрока в день', en: 'Up to {n} minutes in the zone per player per day', uk: 'Не більше {n} хвилин у зоні на гравця за день', es: 'Máximo {n} minutos en la zona por jugador al día', tr: 'Oyuncu başına günde en fazla {n} dakika bölgede', pt: 'No máximo {n} minutos na zona por jogador por dia' },
  farm2DropHdr: { ru: 'Дроп с монстров', en: 'Monster drops', uk: 'Дроп з монстрів', es: 'Botín de los monstruos', tr: 'Canavarlardan düşenler', pt: 'Itens dos monstros' },
  libertyLbl: { ru: 'Liberty', en: 'Liberty', uk: 'Liberty', es: 'Liberty', tr: 'Liberty', pt: 'Liberty' },
  ...
  craftTabConsumables: { ru: 'Расходники', en: 'Consumables', uk: 'Розхідники', es: 'Consumibles', tr: 'Sarf Malzemeleri', pt: 'Consumíveis' },
  craftBuffPotionsHdr: { ru: 'Банки баффов', en: 'Buff jars', uk: 'Банки баффів', es: 'Frascos de mejora', tr: 'Buff kavanozları', pt: 'Frascos de buff' },
  craftBuffPotionYieldFmt: { ru: 'За один крафт: ×{n} банок', en: 'Per craft: ×{n} jars', uk: 'За один крафт: ×{n} банок', es: 'Por elaboración: ×{n} frascos', tr: 'Her üretimde: ×{n} kavanoz', pt: 'Por criação: ×{n} frascos' },
  ...
  craftQtyLbl:      { ru: 'Количество', en: 'Quantity', uk: 'Кількість', es: 'Cantidad', tr: 'Miktar', pt: 'Quantidade' },
  craftQtyMaxBtn:   { ru: 'МАКС', en: 'MAX', uk: 'МАКС', es: 'MÁX', tr: 'MAKS', pt: 'MÁX' },
  craftDoBtnQtyFmt: { ru: 'Крафтить ×{n}', en: 'Craft ×{n}', uk: 'Крафтити ×{n}', es: 'Fabricar ×{n}', tr: 'Üret ×{n}', pt: 'Fabricar ×{n}' },
  craftReceivedQtyFmt: { ru: '✓ Получено: {name} ×{n} из {of}', en: '✓ Received: {name} ×{n} of {of}', uk: '✓ Отримано: {name} ×{n} з {of}', es: '✓ Recibido: {name} ×{n} de {of}', tr: '✓ Alındı: {name} ×{n} / {of}', pt: '✓ Recebido: {name} ×{n} de {of}' },
  ...
  storageSortLbl:   { ru: 'Сортировка', en: 'Sort', uk: 'Сортування', es: 'Ordenar', tr: 'Sırala', pt: 'Ordenar' },
  storageSort_new:  { ru: 'Как положили', en: 'As stored', uk: 'Як поклали', es: 'Según llegada', tr: 'Eklenme sırası', pt: 'Ordem de chegada' },
  storageSort_type: { ru: 'По типу', en: 'By type', uk: 'За типом', es: 'Por tipo', tr: 'Türe göre', pt: 'Por tipo' },
  storageSort_rarity: { ru: 'По редкости', en: 'By rarity', uk: 'За рідкістю', es: 'Por rareza', tr: 'Nadirliğe göre', pt: 'Por raridade' },
  storageSort_name: { ru: 'По названию', en: 'By name', uk: 'За назвою', es: 'Por nombre', tr: 'Ada göre', pt: 'Por nome' },
  storageSort_qty:  { ru: 'По количеству', en: 'By amount', uk: 'За кількістю', es: 'Por cantidad', tr: 'Miktara göre', pt: 'Por quantidade' },
  storageQtyStoreTitle: { ru: 'Положить', en: 'Store', uk: 'Покласти', es: 'Guardar', tr: 'Depola', pt: 'Guardar' },
  storageQtyTakeTitle:  { ru: 'Забрать', en: 'Take', uk: 'Забрати', es: 'Retirar', tr: 'Al', pt: 'Retirar' },
  storageQtyHave:   { ru: 'Всего: {n}', en: 'Total: {n}', uk: 'Усього: {n}', es: 'Total: {n}', tr: 'Toplam: {n}', pt: 'Total: {n}' },
  storageQtyAll:    { ru: 'Все', en: 'All', uk: 'Усі', es: 'Todo', tr: 'Tümü', pt: 'Tudo' },
  storageQtyCancel: { ru: 'Отмена', en: 'Cancel', uk: 'Скасувати', es: 'Cancelar', tr: 'İptal', pt: 'Cancelar' },
  storageQtyGone:   { ru: 'Предмет уже перемещён', en: 'The item has already moved', uk: 'Предмет уже переміщено', es: 'El objeto ya se movió', tr: 'Eşya zaten taşındı', pt: 'O item já foi movido' },
  ...
  clanTabActivity: { ru: 'Активность', en: 'Activity', uk: 'Активність', es: 'Actividad', tr: 'Etkinlik', pt: 'Atividade' },
  ...
  clanActivityEmpty: { ru: 'Пока никто ничего не положил в хранилище', en: 'Nobody has deposited anything yet', uk: 'Поки ніхто нічого не поклав у сховище', es: 'Nadie ha depositado nada todavía', tr: 'Henüz kimse bir şey yatırmadı', pt: 'Ainda ninguém depositou nada' },
  clanActivityLeftClan: { ru: 'покинул клан', en: 'left the clan', uk: 'покинув клан', es: 'dejó el clan', tr: 'klandan ayrıldı', pt: 'saiu do clã' },
  clanActivityQtyFmt: { ru: '{n} Осколков', en: '{n} Shards', uk: '{n} Осколків', es: '{n} Fragmentos', tr: '{n} Parça', pt: '{n} Fragmentos' },
  ...
  // ── Обучение новичка (js/tutorial.js) ──
  tutTitle:     { ru: 'Обучение {n}/{total}', en: 'Tutorial {n}/{total}', uk: 'Навчання {n}/{total}', es: 'Tutorial {n}/{total}', tr: 'Eğitim {n}/{total}', pt: 'Tutorial {n}/{total}' },
  tutAckBtn:    { ru: 'Понятно', en: 'Got it', uk: 'Зрозуміло', es: 'Entendido', tr: 'Anladım', pt: 'Entendi' },
  tutFinishBtn: { ru: 'В бой!', en: 'To battle!', uk: 'До бою!', es: '¡A la batalla!', tr: 'Savaşa!', pt: 'À batalha!' },
  tutSkipBtn:   { ru: 'Пропустить', en: 'Skip', uk: 'Пропустити', es: 'Saltar', tr: 'Atla', pt: 'Pular' },
  tutSkipAsk:   { ru: 'Пропустить обучение? Вернуть его можно в Профиле.', en: 'Skip the tutorial? You can restart it from the Profile.', uk: 'Пропустити навчання? Повернути його можна в Профілі.', es: '¿Saltar el tutorial? Puedes reiniciarlo desde el Perfil.', tr: 'Eğitim atlansın mı? Profil sekmesinden yeniden başlatabilirsin.', pt: 'Pular o tutorial? Você pode reiniciá-lo no Perfil.' },
  tutSkipYes:   { ru: 'Пропустить', en: 'Skip', uk: 'Пропустити', es: 'Saltar', tr: 'Atla', pt: 'Pular' },
  tutSkipNo:    { ru: 'Продолжить', en: 'Keep going', uk: 'Продовжити', es: 'Continuar', tr: 'Devam et', pt: 'Continuar' },
  tutGoTab:     { ru: '👇 Открой вкладку «{tab}» внизу', en: '👇 Open the "{tab}" tab below', uk: '👇 Відкрий вкладку «{tab}» внизу', es: '👇 Abre la pestaña «{tab}» abajo', tr: '👇 Aşağıdan "{tab}" sekmesini aç', pt: '👇 Abra a aba «{tab}» abaixo' },
  tutRestartBtn:{ ru: '📜 Пройти обучение заново', en: '📜 Restart the tutorial', uk: '📜 Пройти навчання знову', es: '📜 Repetir el tutorial', tr: '📜 Eğitimi yeniden başlat', pt: '📜 Refazer o tutorial' },

  tut_lang_t:   { ru: 'Выбери язык', en: 'Choose your language', uk: 'Обери мову', es: 'Elige tu idioma', tr: 'Dilini seç', pt: 'Escolha seu idioma' },
  tut_lang_d:   { ru: 'Язык игры меняется в «Профиль» → «Язык». Если всё устраивает — жми «Понятно».', en: 'The game language is in Profile → Language. Happy with it? Tap "Got it".', uk: 'Мова гри змінюється в «Профіль» → «Мова». Якщо все влаштовує — тисни «Зрозуміло».', es: 'El idioma se cambia en Perfil → Idioma. ¿Todo bien? Pulsa «Entendido».', tr: 'Oyun dili Profil → Dil bölümünden değişir. Memnunsan "Anladım"a dokun.', pt: 'O idioma fica em Perfil → Idioma. Tudo certo? Toque em «Entendi».' },
  tut_move_t:   { ru: 'Пройдись', en: 'Take a walk', uk: 'Пройдися', es: 'Da un paseo', tr: 'Biraz yürü', pt: 'Dê uma volta' },
  tut_move_d:   { ru: 'Зажми джойстик слева внизу и веди палец — герой пойдёт следом.', en: 'Hold the joystick in the bottom-left and slide your finger — your hero follows.', uk: 'Затисни джойстик зліва внизу і веди палець — герой піде слідом.', es: 'Mantén el joystick de abajo a la izquierda y desliza el dedo: tu héroe te sigue.', tr: 'Sol alttaki joystick\'e basılı tut ve parmağını kaydır — kahramanın takip eder.', pt: 'Segure o joystick no canto inferior esquerdo e deslize o dedo — seu herói segue.' },
  tut_portal_t: { ru: 'Иди к телепорту', en: 'Go to the teleport', uk: 'Йди до телепорту', es: 'Ve al teletransporte', tr: 'Işınlayıcıya git', pt: 'Vá ao teleporte' },
  tut_portal_d: { ru: 'Встань на светящийся круг «Телепорт» и выбери «1 уровень» — там первые монстры. Остальные зоны откроются с уровнем.', en: 'Step onto the glowing "Teleport" circle and pick "Level 1" — the first monsters are there. Other zones unlock as you level up.', uk: 'Стань на коло «Телепорт», що світиться, і обери «1 рівень» — там перші монстри. Інші зони відкриються з рівнем.', es: 'Pisa el círculo brillante «Teletransporte» y elige «Nivel 1»: allí están los primeros monstruos. Las demás zonas se abren al subir de nivel.', tr: 'Parlayan "Işınlayıcı" dairesine bas ve "Seviye 1"i seç — ilk canavarlar orada. Diğer bölgeler seviye atladıkça açılır.', pt: 'Pise no círculo brilhante «Teleporte» e escolha «Nível 1» — os primeiros monstros estão lá. As outras zonas abrem conforme você sobe de nível.' },
  tut_kill_t:   { ru: 'Победи монстров', en: 'Defeat monsters', uk: 'Перемож монстрів', es: 'Derrota monstruos', tr: 'Canavarları yen', pt: 'Derrote monstros' },
  tut_kill_d:   { ru: 'Жми большую кнопку с мечом — герой сам подбежит к ближайшему монстру и ударит. За монстров дают опыт, золото и вещи.', en: 'Tap the big sword button — your hero runs to the nearest monster and strikes. Monsters give XP, gold and items.', uk: 'Тисни велику кнопку з мечем — герой сам підбіжить до найближчого монстра і вдарить. За монстрів дають досвід, золото і речі.', es: 'Pulsa el gran botón de la espada: tu héroe corre hacia el monstruo más cercano y ataca. Los monstruos dan XP, oro y objetos.', tr: 'Büyük kılıç tuşuna dokun — kahramanın en yakın canavara koşup vurur. Canavarlar tecrübe, altın ve eşya verir.', pt: 'Toque no grande botão da espada — seu herói corre até o monstro mais próximo e ataca. Monstros dão XP, ouro e itens.' },
  tut_potion_t: { ru: 'Лечись зельем', en: 'Heal with a potion', uk: 'Лікуйся зіллям', es: 'Cúrate con una poción', tr: 'İksirle iyileş', pt: 'Cure-se com uma poção' },
  tut_potion_d: { ru: 'Когда здоровье проседает, жми кнопку с зельем над атакой. Цифра на ней — сколько зелий осталось.', en: 'When your health drops, tap the potion button above the attack. The number on it is how many you have left.', uk: 'Коли здоров\'я просідає, тисни кнопку із зіллям над атакою. Цифра на ній — скільки зілля лишилось.', es: 'Cuando tu salud baje, pulsa el botón de la poción sobre el ataque. El número indica cuántas te quedan.', tr: 'Canın azaldığında saldırının üstündeki iksir tuşuna dokun. Üstündeki sayı kalan iksir sayısıdır.', pt: 'Quando a vida cair, toque no botão da poção acima do ataque. O número nele mostra quantas restam.' },
  tut_quests_t: { ru: 'Загляни в квесты', en: 'Check your quests', uk: 'Зазирни в квести', es: 'Revisa tus misiones', tr: 'Görevlerine bak', pt: 'Veja suas missões' },
  tut_quests_d: { ru: 'Во вкладке «Квесты» — задания с наградами. Выполняй их по ходу игры и забирай награду.', en: 'The Quests tab has tasks with rewards. Complete them as you play and claim the reward.', uk: 'У вкладці «Квести» — завдання з нагородами. Виконуй їх по ходу гри та забирай нагороду.', es: 'La pestaña Misiones tiene tareas con recompensas. Complétalas mientras juegas y reclama el premio.', tr: 'Görevler sekmesinde ödüllü görevler var. Oynarken tamamla ve ödülünü al.', pt: 'A aba Missões tem tarefas com recompensas. Complete-as enquanto joga e pegue a recompensa.' },
  tut_upgrade_t:{ ru: 'Улучши характеристики', en: 'Upgrade your stats', uk: 'Покращ характеристики', es: 'Mejora tus atributos', tr: 'Özelliklerini geliştir', pt: 'Melhore seus atributos' },
  tut_upgrade_d:{ ru: '«Персонаж» → «Улучшения»: качай атаку, защиту, здоровье и другое за золото и очки навыка — очки дают за каждый уровень.', en: 'Character → Upgrades: raise attack, defense, health and more with gold and skill points — you get points every level.', uk: '«Персонаж» → «Покращення»: качай атаку, захист, здоров\'я та інше за золото й очки навички — очки дають за кожен рівень.', es: 'Personaje → Mejoras: sube ataque, defensa, salud y más con oro y puntos de habilidad; ganas puntos en cada nivel.', tr: 'Karakter → Geliştirmeler: altın ve yetenek puanıyla saldırı, savunma, can ve dahasını yükselt — her seviyede puan kazanırsın.', pt: 'Personagem → Melhorias: aumente ataque, defesa, vida e mais com ouro e pontos de habilidade — você ganha pontos a cada nível.' },
  tut_equip_t:  { ru: 'Надень снаряжение', en: 'Equip gear', uk: 'Одягни спорядження', es: 'Equipa tu equipo', tr: 'Ekipman kuşan', pt: 'Equipe itens' },
  tut_equip_d:  { ru: '«Персонаж» → «Инвентарь»: нажми на вещь, которая выпала с монстра, и надень её. Нет вещей — жми «Понятно».', en: 'Character → Inventory: tap an item a monster dropped and equip it. No items yet? Tap "Got it".', uk: '«Персонаж» → «Інвентар»: натисни на річ, що випала з монстра, і одягни її. Немає речей — тисни «Зрозуміло».', es: 'Personaje → Inventario: toca un objeto que soltó un monstruo y equípalo. ¿Sin objetos? Pulsa «Entendido».', tr: 'Karakter → Envanter: canavardan düşen bir eşyaya dokun ve kuşan. Eşyan yoksa "Anladım"a dokun.', pt: 'Personagem → Inventário: toque num item que um monstro deixou e equipe. Sem itens? Toque em «Entendi».' },
  tut_skill_t:  { ru: 'Изучи навык', en: 'Learn a skill', uk: 'Вивчи навичку', es: 'Aprende una habilidad', tr: 'Bir yetenek öğren', pt: 'Aprenda uma habilidade' },
  tut_skill_d:  { ru: 'С монстров падают книги навыков. «Персонаж» → «Навыки»: изучи навык книгой — он появится на кнопке рядом с атакой. Книги нет — жми «Понятно».', en: 'Monsters drop skill books. Character → Skills: learn a skill with a book — it appears on a button next to the attack. No book yet? Tap "Got it".', uk: 'З монстрів падають книги навичок. «Персонаж» → «Навички»: вивчи навичку книгою — вона з\'явиться на кнопці біля атаки. Книги немає — тисни «Зрозуміло».', es: 'Los monstruos sueltan libros de habilidad. Personaje → Habilidades: aprende una con un libro y aparecerá en un botón junto al ataque. ¿Sin libro? Pulsa «Entendido».', tr: 'Canavarlar yetenek kitabı düşürür. Karakter → Yetenekler: kitapla bir yetenek öğren — saldırının yanındaki tuşta belirir. Kitabın yoksa "Anladım"a dokun.', pt: 'Monstros deixam livros de habilidade. Personagem → Habilidades: aprenda uma com um livro — ela aparece num botão ao lado do ataque. Sem livro? Toque em «Entendi».' },
  tut_level_t:  { ru: 'Дойди до 10 уровня', en: 'Reach level 10', uk: 'Дійди до 10 рівня', es: 'Llega al nivel 10', tr: '10. seviyeye ulaş', pt: 'Chegue ao nível 10' },
  tut_level_d:  { ru: 'Бей монстров и улучшайся. С уровнем открываются новые телепорты (20, 40, 60) и Фарм зона — там монстры сильнее, а награды больше.', en: 'Fight monsters and upgrade. Levels unlock new teleports (20, 40, 60) and the Farm Zone — tougher monsters, bigger rewards.', uk: 'Бий монстрів і покращуйся. З рівнем відкриваються нові телепорти (20, 40, 60) і Ферм-зона — там монстри сильніші, а нагороди більші.', es: 'Lucha y mejora. Al subir de nivel se abren nuevos teletransportes (20, 40, 60) y la Zona de Farmeo: monstruos más duros, mejores premios.', tr: 'Canavar kes ve gelişmeye devam et. Seviyeler yeni ışınlayıcıları (20, 40, 60) ve Farm Bölgesini açar — daha zor canavarlar, daha büyük ödüller.', pt: 'Lute e evolua. Os níveis abrem novos teleportes (20, 40, 60) e a Zona de Farm — monstros mais fortes, recompensas maiores.' },
  tut_final_t:  { ru: 'Обучение пройдено! 🎉', en: 'Tutorial complete! 🎉', uk: 'Навчання пройдено! 🎉', es: '¡Tutorial completado! 🎉', tr: 'Eğitim tamamlandı! 🎉', pt: 'Tutorial concluído! 🎉' },
  tut_final_d:  { ru: 'Дальше — кланы, PvP, подземелья и рынок. Загляни в «Меню» справа вверху. Удачи, герой!', en: 'Next up: clans, PvP, dungeons and the market. Check the "Menu" in the top right. Good luck, hero!', uk: 'Далі — клани, PvP, підземелля і ринок. Зазирни в «Меню» праворуч угорі. Удачі, герою!', es: 'Lo siguiente: clanes, PvP, mazmorras y el mercado. Mira el «Menú» arriba a la derecha. ¡Suerte, héroe!', tr: 'Sırada klanlar, PvP, zindanlar ve pazar var. Sağ üstteki "Menü"ye göz at. Bol şans, kahraman!', pt: 'A seguir: clãs, PvP, masmorras e o mercado. Veja o «Menu» no canto superior direito. Boa sorte, herói!' },
};
...
Object.assign(I18N_UI, {
  ...
  farmHighShort:   { ru: 'Ферма 2', en: 'Farm 2', uk: 'Ферма 2', es: 'Granja 2', tr: 'Farm 2', pt: 'Fazenda 2' },
...
Object.assign(I18N_UI, {
  ...
  autoBuffsHdr: { ru: 'Автоприём зелий усиления', en: 'Auto-use buff potions', uk: 'Автоприйом зілля посилення', es: 'Uso automático de pociones de mejora', tr: 'Güçlendirme iksirlerini otomatik kullan', pt: 'Uso automático de poções de reforço' },
  ...
  statHpPctLbl: { ru: 'HP %', en: 'HP %', uk: 'HP %', es: 'HP %', tr: 'HP %', pt: 'HP %' },
  statAtkPctLbl: { ru: 'Атака %', en: 'Attack %', uk: 'Атака %', es: 'Ataque %', tr: 'Saldırı %', pt: 'Ataque %' },
  statXpPctLbl: { ru: 'Опыт %', en: 'XP %', uk: 'Досвід %', es: 'XP %', tr: 'Tecrübe %', pt: 'XP %' },
  statDropPctLbl: { ru: 'Дроп %', en: 'Drop %', uk: 'Дроп %', es: 'Drop %', tr: 'Düşüş %', pt: 'Drop %' },
  ...
  charStatsSubTab: { ru: 'Характеристики', en: 'Stats', uk: 'Характеристики', es: 'Estadísticas', tr: 'Statlar', pt: 'Atributos' },
  allBonusesSubTab: { ru: 'Все бонусы', en: 'All bonuses', uk: 'Усі бонуси', es: 'Todas las bonificaciones', tr: 'Tüm bonuslar', pt: 'Todos os bônus' },
  allBonusXpLbl: { ru: 'Опыт', en: 'Experience', uk: 'Досвід', es: 'Experiencia', tr: 'Tecrübe', pt: 'Experiência' },
  allBonusGoldLbl: { ru: 'Золото', en: 'Gold', uk: 'Золото', es: 'Oro', tr: 'Altın', pt: 'Ouro' },
  allBonusDropLbl: { ru: 'Доп. шанс дропа', en: 'Extra drop chance', uk: 'Дод. шанс дропу', es: 'Probabilidad extra de botín', tr: 'Ek eşya düşme şansı', pt: 'Chance extra de item' },
  allBonusNexumLbl: { ru: 'Шанс Liberty (фарм-зоны)', en: 'Liberty chance (farm zones)', uk: 'Шанс Liberty (ферм-зони)', es: 'Probabilidad de Liberty (zonas de farmeo)', tr: 'Liberty şansı (farm bölgeleri)', pt: 'Chance de Liberty (zonas de farm)' },
  allBonusNexumHint: { ru: 'Множитель к шансу, а не прибавка, и работает только в фарм-зонах и Сотрудничестве', en: 'A multiplier to the chance, not an addition, and only applies in the farm zones and Co-op', uk: 'Множник до шансу, а не прибавка, і працює лише у ферм-зонах та Співробітництві', es: 'Un multiplicador de la probabilidad, no una suma, y solo aplica en las zonas de farmeo y en Cooperación', tr: 'Şansa eklenen değil, çarpan bir bonustur ve yalnızca farm bölgelerinde ve İş Birliğinde geçerlidir', pt: 'Um multiplicador da chance, não uma soma, e só se aplica nas zonas de farm e na Cooperação' },
  allBonusFromVip: { ru: 'От VIP', en: 'From VIP', uk: 'Від VIP', es: 'De VIP', tr: 'VIP\'den', pt: 'De VIP' },
  allBonusFromClan: { ru: 'От клана', en: 'From clan', uk: 'Від клану', es: 'Del clan', tr: 'Klandan', pt: 'Do clã' },
  allBonusFromTicket: { ru: 'От сезонного билета', en: 'From season ticket', uk: 'Від сезонного квитка', es: 'Del pase de temporada', tr: 'Sezon biletinden', pt: 'Do passe de temporada' },
  allBonusFromGear: { ru: 'От снаряжения и рун', en: 'From gear and runes', uk: 'Від спорядження і рун', es: 'Del equipo y las runas', tr: 'Ekipman ve runlardan', pt: 'Do equipamento e runas' },
  empowerDesc: { ru: 'Даёт +15 очков навыка навсегда и НИЧЕГО не сбрасывает: уровень, опыт, статы и уже вложенные улучшения остаются как были. Доступно с 30 уровня, в Зале, и повторяется — цена растёт по мере того, сколько усилений уже пройдено.', en: 'Grants +15 skill points forever and resets NOTHING: your level, experience, stats and the upgrades you already invested all stay as they are. Available from level 30, in the Hall, and repeatable — the price grows with how many empowerments you have already done.', uk: 'Дає +15 очок навички назавжди і НІЧОГО не скидає: рівень, досвід, стати та вже вкладені покращення лишаються як були. Доступно з 30 рівня, у Залі, і повторюється — ціна зростає з кожним пройденим посиленням.', es: 'Otorga +15 puntos de habilidad para siempre y NO reinicia nada: tu nivel, experiencia, estadísticas y las mejoras ya invertidas se mantienen igual. Disponible desde el nivel 30, en la Sala, y repetible — el precio sube según cuántas potenciaciones ya hiciste.', tr: 'Kalıcı olarak +15 yetenek puanı verir ve HİÇBİR ŞEYİ sıfırlamaz: seviyen, deneyimin, statların ve zaten yatırdığın geliştirmeler olduğu gibi kalır. 30. seviyeden itibaren, Salonda kullanılabilir ve tekrarlanabilir — fiyat, kaç güçlendirme yaptığına göre artar.', pt: 'Concede +15 pontos de habilidade para sempre e NÃO reinicia nada: seu nível, experiência, atributos e as melhorias já investidas permanecem como estão. Disponível a partir do nível 30, no Salão, e repetível — o preço cresce conforme quantas potencializações você já fez.' },
  empowerLevelReqFmt: { ru: 'Уровень {cur} / {lvl} для усиления', en: 'Level {cur} / {lvl} to empower', uk: 'Рівень {cur} / {lvl} для посилення', es: 'Nivel {cur} / {lvl} para potenciar', tr: 'Güçlendirme için seviye {cur} / {lvl}', pt: 'Nível {cur} / {lvl} para potencializar' },
  ...
  empowerBtn: { ru: 'Усилиться', en: 'Empower', uk: 'Посилитися', es: 'Potenciar', tr: 'Güçlen', pt: 'Potencializar' },
  empowerCountFmt: { ru: 'Усилений пройдено: {n} / {max}', en: 'Empowerments done: {n} / {max}', uk: 'Посилень пройдено: {n} / {max}', es: 'Potenciaciones hechas: {n} / {max}', tr: 'Yapılan güçlendirme: {n} / {max}', pt: 'Potencializações feitas: {n} / {max}' },
  empowerMultFmt: { ru: 'Усиление №{n} — стоимость ×{mult}', en: 'Empowerment #{n} — cost ×{mult}', uk: 'Посилення №{n} — вартість ×{mult}', es: 'Potenciación n.º {n} — coste ×{mult}', tr: 'Güçlendirme #{n} — maliyet ×{mult}', pt: 'Potencialização nº {n} — custo ×{mult}' },
  empowerCapFmt: { ru: 'Достигнут предел — больше {max} усилений не бывает', en: 'Limit reached — there is no empowerment past {max}', uk: 'Досягнуто межу — більше {max} посилень не буває', es: 'Límite alcanzado — no hay potenciación más allá de {max}', tr: 'Sınıra ulaşıldı — {max} üstü güçlendirme yok', pt: 'Limite atingido — não há potencialização além de {max}' },
  ...
  empowerConfirmBody: { ru: 'Вы получите +15 очков навыка навсегда. Уровень, опыт и улучшения останутся как есть — ничего не сбрасывается. Указанные предметы будут потрачены.', en: 'You will receive +15 skill points forever. Your level, experience and upgrades stay exactly as they are — nothing is reset. The listed items will be consumed.', uk: 'Ви отримаєте +15 очок навички назавжди. Рівень, досвід і покращення лишаться як є — нічого не скидається. Вказані предмети буде витрачено.', es: 'Recibirás +15 puntos de habilidad para siempre. Tu nivel, experiencia y mejoras se mantienen tal cual — nada se reinicia. Los objetos indicados se consumirán.', tr: 'Kalıcı olarak +15 yetenek puanı alacaksın. Seviyen, deneyimin ve geliştirmelerin olduğu gibi kalır — hiçbir şey sıfırlanmaz. Listelenen eşyalar harcanacak.', pt: 'Você receberá +15 pontos de habilidade para sempre. Seu nível, experiência e melhorias permanecem como estão — nada é reiniciado. Os itens listados serão consumidos.' },
  empowerGo: { ru: 'Усилиться', en: 'Empower', uk: 'Посилитися', es: 'Potenciar', tr: 'Güçlen', pt: 'Potencializar' },
  empowerDoneToast: { ru: '✓ Усиление получено!', en: '✓ Empowerment granted!', uk: '✓ Посилення отримано!', es: '✓ ¡Potenciación obtenida!', tr: '✓ Güçlendirme alındı!', pt: '✓ Potencialização obtida!' },
  ...
  // ── пятый слот: заимствованная способность (джекпот переработки
  // ОРУЖЕЙНОЙ легендарной руны, RUNE_REROLL_BONUS_SKILL_CHANCE) — никогда
  // не выбор игрока, поэтому здесь нет ни "доступна книга", ни подтверждения
  // изучения/замены: только заголовок карточки и объяснение, откуда она.
  foreignSkillHdr: { ru: 'Заимствованная способность', en: 'Borrowed ability', uk: 'Запозичена здібність', es: 'Habilidad prestada', tr: 'Ödünç yetenek', pt: 'Habilidade emprestada' },
  foreignSkillTiedToRuneNote: { ru: 'Даёт легендарная руна оружия — снимете её или смените оружие, слот опустеет (но ничего не потеряется)', en: 'Granted by a legendary weapon rune — unsocket it or switch weapons and the slot empties (nothing is lost)', uk: 'Дає легендарна руна зброї — знімете її чи зміните зброю, слот спорожніє (але нічого не втратиться)', es: 'La otorga una runa legendaria de arma — quítala o cambia de arma y la ranura queda vacía (nada se pierde)', tr: 'Efsanevi silah rünü verir — sökersen veya silah değiştirirsen yuva boşalır (hiçbir şey kaybolmaz)', pt: 'Concedida por uma runa lendária de arma — remova-a ou troque de arma e o slot esvazia (nada se perde)' },
  ...
  enhSafeCardDesc: { ru: 'Редкий камень. Если заточка не удастся — предмет останется целым, пропадёт только попытка.', en: 'Rare stone. If the enchant fails, the item stays intact — only the attempt is lost.', uk: 'Рідкісний камінь. Якщо гартування не вдасться — предмет залишиться цілим, пропаде лише спроба.', es: 'Piedra rara. Si el encantamiento falla, el objeto queda intacto: solo se pierde el intento.', tr: 'Nadir taş. Büyü başarısız olursa eşya sağlam kalır — sadece deneme kaybolur.', pt: 'Pedra rara. Se o encantamento falhar, o item permanece intacto — só a tentativa é perdida.' },
  enhTryBtnLbl: { ru: 'Заточить', en: 'Enchant', uk: 'Гартувати', es: 'Encantar', tr: 'Büyüle', pt: 'Encantar' },
  enhInProgressLbl: { ru: 'Идёт заточка…', en: 'Enchanting…', uk: 'Триває гартування…', es: 'Encantando…', tr: 'Büyüleniyor…', pt: 'Encantando…' },
  enhContinueBtnLbl: { ru: 'Продолжить', en: 'Continue', uk: 'Продовжити', es: 'Continuar', tr: 'Devam et', pt: 'Continuar' },
  ...
  compareBtn: { ru: 'Сравнить', en: 'Compare', uk: 'Порівняти', es: 'Comparar', tr: 'Karşılaştır', pt: 'Comparar' },
  compareTitle: { ru: 'Сравнение предметов', en: 'Item Comparison', uk: 'Порівняння предметів', es: 'Comparación de Objetos', tr: 'Eşya Karşılaştırma', pt: 'Comparação de Itens' },
  compareEquippedLbl: { ru: 'Надето сейчас', en: 'Currently Equipped', uk: 'Надіто зараз', es: 'Equipado Actualmente', tr: 'Şu Anda Takılı', pt: 'Equipado Atualmente' },
  compareMarketLbl: { ru: 'Лот на рынке', en: 'Market Listing', uk: 'Лот на ринку', es: 'Anuncio del Mercado', tr: 'Pazardaki İlan', pt: 'Anúncio do Mercado' },
  compareEmptySlotLbl: { ru: 'Слот пуст', en: 'Slot is empty', uk: 'Слот порожній', es: 'Ranura vacía', tr: 'Yuva boş', pt: 'Slot vazio' },
  compareNoStatsLbl: { ru: 'Нет характеристик', en: 'No stats', uk: 'Немає характеристик', es: 'Sin estadísticas', tr: 'İstatistik yok', pt: 'Sem estatísticas' },
  itemDetailsTitle: { ru: 'Характеристики предмета', en: 'Item Details', uk: 'Характеристики предмета', es: 'Detalles del Objeto', tr: 'Eşya Detayları', pt: 'Detalhes do Item' },
  ...
  gramPkgLabel_books_weapon: { ru: 'Книги и оружие', en: 'Books & Weapon', uk: 'Книги і зброя', es: 'Libros y arma', tr: 'Kitaplar ve Silah', pt: 'Livros e Arma' },
  gramPkgLabel_potions_gold: { ru: 'Зелья и золото', en: 'Potions & Gold', uk: 'Зілля і золото', es: 'Pociones y oro', tr: 'İksirler ve Altın', pt: 'Poções e Ouro' },
  gramPkgLabel_liberty_bag: { ru: '700 Либерти', en: '700 Liberty', uk: '700 Ліберті', es: '700 Libertad', tr: '700 Liberty', pt: '700 Liberdade' },
  ...
  mailBonusFreeHdr: { ru: 'Для всех', en: 'For everyone', uk: 'Для всіх', es: 'Para todos', tr: 'Herkes için', pt: 'Para todos' },
  mailBonusTicketHdr: { ru: 'С сезонным билетом', en: 'With the season ticket', uk: 'Із сезонним квитком', es: 'Con el pase de temporada', tr: 'Sezon biletiyle', pt: 'Com o passe de temporada' },
  mailBonusNeedTicket: { ru: 'нужен билет', en: 'ticket required', uk: 'потрібен квиток', es: 'requiere el pase', tr: 'bilet gerekli', pt: 'requer o passe' },
  mailBonusHaveTicket: { ru: 'у вас есть билет', en: 'you hold the ticket', uk: 'у вас є квиток', es: 'ya tienes el pase', tr: 'biletiniz var', pt: 'você tem o passe' },
  mailBonusClaimBtn: { ru: 'Забрать', en: 'Claim', uk: 'Забрати', es: 'Reclamar', tr: 'Al', pt: 'Resgatar' },
  mailBonusDoneToast: { ru: '✓ Письмо получено!', en: '✓ Mail claimed!', uk: '✓ Лист отримано!', es: '✓ ¡Carta recibida!', tr: '✓ Mektup alındı!', pt: '✓ Carta recebida!' },
  mailBonusDoneTicketToast: { ru: '✓ Награда за сезонный билет!', en: '✓ Season-ticket reward!', uk: '✓ Нагорода за сезонний квиток!', es: '✓ ¡Recompensa del pase de temporada!', tr: '✓ Sezon bileti ödülü!', pt: '✓ Recompensa do passe de temporada!' },
  ...
  starterBonusBuffFmt: { ru: '+ «Награда новичка»: опыт ×{xp}, атака ×{atk}, защита ×{def} на {days} дн.', en: '+ "Newbie reward": ×{xp} XP, ×{atk} ATK, ×{def} DEF for {days} days', uk: '+ «Нагорода новачка»: досвід ×{xp}, атака ×{atk}, захист ×{def} на {days} дн.', es: '+ "Recompensa de novato": XP ×{xp}, ATQ ×{atk}, DEF ×{def} durante {days} días', tr: '+ "Acemi ödülü": ×{xp} XP, ×{atk} saldırı, ×{def} savunma, {days} gün', pt: '+ "Recompensa de novato": XP ×{xp}, ATQ ×{atk}, DEF ×{def} por {days} dias' },
  ...
  friendshipBtnLbl: { ru: 'Дружба', en: 'Friendship', uk: 'Дружба', es: 'Amistad', tr: 'Dostluk', pt: 'Amizade' },
  friendshipTitle: { ru: 'Дружба', en: 'Friendship', uk: 'Дружба', es: 'Amistad', tr: 'Dostluk', pt: 'Amizade' },
  friendshipDesc: { ru: 'Награда за друзей, которых вы пригласили и которые дошли до {lvl} уровня. Набор друзей закрыт: считаются только уже приглашённые, новые приглашения больше не засчитываются. Каждый тир можно забрать один раз.', en: 'A reward for friends you invited who reached level {lvl}. Invitations are closed: only friends already invited count, new invitations no longer do. Each tier can be claimed once.', uk: 'Нагорода за друзів, яких ви запросили і які досягли {lvl} рівня. Набір друзів закрито: рахуються лише вже запрошені, нові запрошення більше не зараховуються. Кожен тир можна забрати один раз.', es: 'Una recompensa por los amigos que invitaste y que alcanzaron el nivel {lvl}. Las invitaciones están cerradas: solo cuentan los amigos ya invitados, las nuevas invitaciones ya no cuentan. Cada nivel se puede reclamar una vez.', tr: 'Davet ettiğiniz ve {lvl}. seviyeye ulaşan arkadaşlarınız için bir ödül. Davetler kapandı: yalnızca zaten davet edilmiş arkadaşlar sayılır, yeni davetler artık sayılmaz. Her kademe bir kez alınabilir.', pt: 'Uma recompensa pelos amigos que você convidou e que chegaram ao nível {lvl}. Os convites estão encerrados: só contam os amigos já convidados, novos convites não contam mais. Cada nível pode ser resgatado uma vez.' },
  friendshipProgressFmt: { ru: 'У вас {n} друзей {lvl}+ уровня', en: 'You have {n} friends level {lvl}+', uk: 'У вас {n} друзів {lvl}+ рівня', es: 'Tienes {n} amigos de nivel {lvl}+', tr: '{lvl}+ seviyesinde {n} arkadaşınız var', pt: 'Você tem {n} amigos nível {lvl}+' },
  friendshipTierFmt: { ru: '{n} друзей', en: '{n} friends', uk: '{n} друзів', es: '{n} amigos', tr: '{n} arkadaş', pt: '{n} amigos' },
  friendshipClaimBtn: { ru: 'Забрать', en: 'Claim', uk: 'Забрати', es: 'Reclamar', tr: 'Al', pt: 'Resgatar' },
  ...
  friendshipNoFriendsHint: { ru: 'Засчитанных друзей нет — набор друзей закрыт.', en: 'No counted friends — invitations are closed.', uk: 'Зарахованих друзів немає — набір друзів закрито.', es: 'No hay amigos contados — las invitaciones están cerradas.', tr: 'Sayılan arkadaş yok — davetler kapandı.', pt: 'Nenhum amigo contado — os convites estão encerrados.' },
  ...
  shopTierStarter:   { ru: 'Стартовый',    en: 'Starter',    uk: 'Стартовий',    es: 'Inicial',      tr: 'Başlangıç',  pt: 'Inicial' },
  shopTierBasic:     { ru: 'Базовый',      en: 'Basic',      uk: 'Базовий',      es: 'Básico',       tr: 'Temel',      pt: 'Básico' },
  ...
  gramWalletHdr: { ru: 'Кошелёк TON', en: 'TON wallet', uk: 'Гаманець TON', es: 'Cartera TON', tr: 'TON cüzdanı', pt: 'Carteira TON' },
  tcNotConnectedHint: { ru: 'Подключите кошелёк — пополнение и вывод в один тап', en: 'Connect a wallet — deposit and withdraw in one tap', uk: 'Підключіть гаманець — поповнення та виведення в один тап', es: 'Conecta una cartera: depositar y retirar en un toque', tr: 'Bir cüzdan bağla — tek dokunuşla yatır ve çek', pt: 'Conecte uma carteira — depositar e sacar em um toque' },
  tcUnlinkConfirmToast: { ru: 'Кошелёк отвязан', en: 'Wallet unlinked', uk: 'Гаманець відв\'язано', es: 'Cartera desvinculada', tr: 'Cüzdan bağlantısı kaldırıldı', pt: 'Carteira desvinculada' },
  tcAddressLbl: { ru: 'Адрес', en: 'Address', uk: 'Адреса', es: 'Dirección', tr: 'Adres', pt: 'Endereço' },
  gramAvailableLbl: { ru: 'Доступно', en: 'Available', uk: 'Доступно', es: 'Disponible', tr: 'Kullanılabilir', pt: 'Disponível' },
  txExpiredLbl: { ru: 'Истёк', en: 'Expired', uk: 'Минув', es: 'Expirado', tr: 'Süresi doldu', pt: 'Expirado' },
  txForfeitedLbl: { ru: 'Аннулировано', en: 'Forfeited', uk: 'Анульовано', es: 'Anulado', tr: 'İptal edildi', pt: 'Anulado' },
  txMemoLbl: { ru: 'Код', en: 'Code', uk: 'Код', es: 'Código', tr: 'Kod', pt: 'Código' },
  airdropSoonLbl: { ru: 'Скоро', en: 'Soon', uk: 'Скоро', es: 'Pronto', tr: 'Yakında', pt: 'Em breve' },
  gramBalanceLbl: { ru: 'Баланс GRAM', en: 'GRAM Balance', uk: 'Баланс GRAM', es: 'Saldo GRAM', tr: 'GRAM Bakiyesi', pt: 'Saldo GRAM' },
  // No arrow glyph in the label any more: the button carries a real inlined
  // SVG icon now (_gramIconDeposit), and '↓ ↓ Пополнить' is what you get when a
  // text arrow survives alongside it.
  ...
  depositCodeLeftFmt: { ru: 'осталось {n}', en: '{n} left', uk: 'залишилось {n}', es: 'quedan {n}', tr: '{n} kaldı', pt: 'restam {n}' },
  ...
  // only confirmation there is now: nothing in the client can tell the money
  // moved, so if this is not shown the deposit is invisible until the player
  // happens to reopen the tab and read the balance.
  depositWatchingTitle: { ru: 'Ждём ваш перевод', en: 'Waiting for your transfer', uk: 'Чекаємо ваш переказ', es: 'Esperando tu transferencia', tr: 'Transferini bekliyoruz', pt: 'Aguardando sua transferência' },
  depositWatchingDesc: { ru: 'Окно можно закрыть — зачисление придёт в любом случае.', en: 'You can close this — the credit arrives either way.', uk: 'Вікно можна закрити — зарахування прийде в будь-якому разі.', es: 'Puedes cerrar esto: el abono llegará igualmente.', tr: 'Bunu kapatabilirsin — yükleme yine de gelir.', pt: 'Pode fechar — o crédito chega de qualquer forma.' },
  depositSafeNote: { ru: 'Ничего не потеряется: сканер сети досчитает перевод, даже если подтверждение задержится.', en: 'Nothing is lost: the chain scanner picks the transfer up even if confirmation is slow.', uk: 'Нічого не загубиться: сканер мережі дорахує переказ, навіть якщо підтвердження затримається.', es: 'Nada se pierde: el escáner de la red registra la transferencia aunque la confirmación tarde.', tr: 'Hiçbir şey kaybolmaz: ağ tarayıcısı onay gecikse bile transferi yakalar.', pt: 'Nada se perde: o scanner da rede registra a transferência mesmo se a confirmação demorar.' },
  depositCreditedTitle: { ru: 'Пополнение зачислено', en: 'Deposit credited', uk: 'Поповнення зараховано', es: 'Depósito acreditado', tr: 'Yatırma hesabına geçti', pt: 'Depósito creditado' },
  depositCreditedAmountFmt: { ru: '+{n} GRAM', en: '+{n} GRAM', uk: '+{n} GRAM', es: '+{n} GRAM', tr: '+{n} GRAM', pt: '+{n} GRAM' },
  depositNewBalanceFmt: { ru: 'Новый баланс — {n} GRAM', en: 'New balance — {n} GRAM', uk: 'Новий баланс — {n} GRAM', es: 'Nuevo saldo — {n} GRAM', tr: 'Yeni bakiye — {n} GRAM', pt: 'Novo saldo — {n} GRAM' },
  depositAnotherBtn: { ru: 'Пополнить ещё', en: 'Deposit again', uk: 'Поповнити ще', es: 'Depositar otra vez', tr: 'Tekrar yatır', pt: 'Depositar de novo' },
  depositDoneBtn: { ru: 'Готово', en: 'Done', uk: 'Готово', es: 'Listo', tr: 'Tamam', pt: 'Pronto' },
  depositTxHashLbl: { ru: 'Транзакция', en: 'Transaction', uk: 'Транзакція', es: 'Transacción', tr: 'İşlem', pt: 'Transação' },
  // ── signed, not yet credited ───────────────────────────────────────────
  // The state between the wallet's confirmation and the chain scanner's. It
  // says how long the ordinary case takes and that the window may be closed,
  // because a player who thinks they must stand and watch reads a two-minute
  // confirmation as a hang.
  depositSentTitle: { ru: 'Перевод отправлен', en: 'Transfer sent', uk: 'Переказ надіслано', es: 'Transferencia enviada', tr: 'Transfer gönderildi', pt: 'Transferência enviada' },
  depositSentAmountFmt: { ru: '{n} GRAM', en: '{n} GRAM', uk: '{n} GRAM', es: '{n} GRAM', tr: '{n} GRAM', pt: '{n} GRAM' },
  depositSentCodeFmt: { ru: 'Код {n}', en: 'Code {n}', uk: 'Код {n}', es: 'Código {n}', tr: 'Kod {n}', pt: 'Código {n}' },
  depositSentDesc: { ru: 'Ждём зачисления. Обычно это занимает меньше минуты. Окно можно закрыть — GRAM придут в любом случае.', en: 'Waiting for the credit. It usually takes under a minute. You can close this — the GRAM arrive either way.', uk: 'Чекаємо на зарахування. Зазвичай це займає менше хвилини. Вікно можна закрити — GRAM надійдуть у будь-якому разі.', es: 'Esperando el abono. Normalmente tarda menos de un minuto. Puedes cerrar esto: los GRAM llegarán igualmente.', tr: 'Yüklemeyi bekliyoruz. Genellikle bir dakikadan kısa sürer. Bunu kapatabilirsin — GRAM yine de gelir.', pt: 'Aguardando o crédito. Normalmente leva menos de um minuto. Pode fechar — os GRAM chegam de qualquer forma.' },
  // Past three minutes. Late, not lost — and the note under it is the part
  // that has to be true: the intent stays matchable for seven days.
  depositSlowTitle: { ru: 'Зачисление задерживается', en: 'The credit is taking longer', uk: 'Зарахування затримується', es: 'El abono está tardando', tr: 'Yükleme gecikiyor', pt: 'O crédito está demorando' },
  depositSlowDesc: { ru: 'Перевод ещё не найден в сети. Так бывает: подтверждение иногда идёт дольше обычного.', en: 'The transfer has not turned up on the network yet. It happens — confirmation is sometimes slower than usual.', uk: 'Переказ ще не знайдено в мережі. Так буває: підтвердження іноді йде довше за звичайне.', es: 'La transferencia aún no aparece en la red. Pasa: a veces la confirmación tarda más de lo normal.', tr: 'Transfer ağda henüz görünmedi. Olur — onay bazen normalden uzun sürer.', pt: 'A transferência ainda não apareceu na rede. Acontece: a confirmação às vezes demora mais que o normal.' },
  depositSlowNote: { ru: 'Код остаётся действительным несколько дней. Как только перевод найдётся, GRAM зачислятся сами — даже если закрыть окно.', en: 'The code stays valid for several days. As soon as the transfer turns up the GRAM are credited on their own — even with this window closed.', uk: 'Код залишається дійсним кілька днів. Щойно переказ знайдеться, GRAM зарахуються самі — навіть якщо закрити вікно.', es: 'El código sigue siendo válido varios días. En cuanto aparezca la transferencia, los GRAM se acreditan solos, incluso con esta ventana cerrada.', tr: 'Kod birkaç gün geçerli kalır. Transfer göründüğü anda GRAM kendiliğinden yüklenir — bu pencere kapalı olsa bile.', pt: 'O código continua válido por vários dias. Assim que a transferência aparecer, os GRAM são creditados sozinhos — mesmo com esta janela fechada.' },
  ...
  farmHighSeasonLbl: { ru: '🎟 Фарм зона 2 · сезонные комнаты', en: '🎟 Farm Zone 2 · season rooms', uk: '🎟 Ферм-зона 2 · сезонні кімнати', es: '🎟 Zona de Farmeo 2 · salas de temporada', tr: '🎟 Farm Bölgesi 2 · sezon odaları', pt: '🎟 Zona de Farm 2 · salas de temporada' },
  ...
  // Тот же список, вариант Фарм зоны 2 — полоса и заголовки её книжных
  // наборов подставляются числами, потому что зона может переехать, а строка
  // перевода — нет (см. _farmHighMonsterListHtml, js/ui.js).
  farmHighBestiaryHint: { ru: 'Снаряжение и книги поделены между видами: шанс у всех одинаковый, но каждый вид роняет свой набор. Уровень у каждого монстра свой, {a}-{b} — здесь показан средний.', en: 'Gear and books are split between species: the chance is the same for all of them, but each species drops its own set. Each monster rolls its own level, {a}-{b} — shown here is the average.', uk: 'Спорядження та книги поділені між видами: шанс в усіх однаковий, але кожен вид роняє свій набір. Рівень у кожного монстра свій, {a}-{b} — тут показано середній.', es: 'El equipo y los libros están repartidos entre las especies: la probabilidad es la misma para todas, pero cada especie suelta su propio conjunto. Cada monstruo tiene su nivel, {a}-{b} — aquí se muestra el promedio.', tr: 'Ekipman ve kitaplar türler arasında paylaştırılmıştır: şans hepsinde aynıdır ama her tür kendi setini düşürür. Her canavarın kendi seviyesi var, {a}-{b} — burada ortalama gösteriliyor.', pt: 'Equipamento e livros são divididos entre as espécies: a chance é a mesma para todas, mas cada espécie solta o seu próprio conjunto. Cada monstro sorteia o seu nível, {a}-{b} — aqui é mostrada a média.' },
  farmHighLevelRangeFmt: { ru: 'Уровень {a}-{b}', en: 'Level {a}-{b}', uk: 'Рівень {a}-{b}', es: 'Nivel {a}-{b}', tr: 'Seviye {a}-{b}', pt: 'Nível {a}-{b}' },
  farmHighSkillBooksHdr: { ru: 'Книги 1-й профессии', en: '1st profession books', uk: 'Книги 1-ї професії', es: 'Libros de 1.ª profesión', tr: '1. meslek kitapları', pt: 'Livros da 1.ª profissão' },
  farmHighAdvBooksHdr: { ru: 'Книги 2-й профессии', en: '2nd profession books', uk: 'Книги 2-ї професії', es: 'Libros de 2.ª profesión', tr: '2. meslek kitapları', pt: 'Livros da 2.ª profissão' },
  ...
  tcDisconnectBtn: { ru: 'Отвязать', en: 'Unlink', uk: 'Відв\'язати', es: 'Desvincular', tr: 'Bağlantıyı kaldır', pt: 'Desvincular' },
  ...
  tcLinkedLbl: { ru: 'Кошелёк привязан', en: 'Wallet linked', uk: 'Гаманець прив\'язано', es: 'Billetera vinculada', tr: 'Cüzdan bağlı', pt: 'Carteira vinculada' },
  tcNoSessionHere: { ru: 'На этом устройстве кошелёк не подключён — отправить перевод отсюда нельзя', en: 'No wallet is connected on this device — you cannot send from here', uk: 'На цьому пристрої гаманець не підключено — надіслати переказ звідси не можна', es: 'No hay billetera conectada en este dispositivo: no puedes enviar desde aquí', tr: 'Bu cihazda bağlı cüzdan yok — buradan gönderemezsiniz', pt: 'Nenhuma carteira conectada neste dispositivo — não dá para enviar daqui' },
  tcConnectHereBtn: { ru: 'Подключить на этом устройстве', en: 'Connect on this device', uk: 'Підключити на цьому пристрої', es: 'Conectar en este dispositivo', tr: 'Bu cihazda bağla', pt: 'Conectar neste dispositivo' },
  tcOtherWalletHere: { ru: 'На этом устройстве подключён другой кошелёк', en: 'A different wallet is connected on this device', uk: 'На цьому пристрої підключено інший гаманець', es: 'En este dispositivo hay conectada otra billetera', tr: 'Bu cihazda başka bir cüzdan bağlı', pt: 'Outra carteira está conectada neste dispositivo' },
  tcUseThisWalletBtn: { ru: 'Привязать этот кошелёк', en: 'Link this wallet', uk: 'Прив\'язати цей гаманець', es: 'Vincular esta billetera', tr: 'Bu cüzdanı bağla', pt: 'Vincular esta carteira' },
  tcNoLocalSessionMsg: { ru: 'Кошелёк не подключён на этом устройстве — подключите его здесь, чтобы отправить перевод', en: 'The wallet is not connected on this device — connect it here to send', uk: 'Гаманець не підключено на цьому пристрої — підключіть його тут, щоб надіслати переказ', es: 'La billetera no está conectada en este dispositivo: conéctala aquí para enviar', tr: 'Cüzdan bu cihazda bağlı değil — göndermek için burada bağlayın', pt: 'A carteira não está conectada neste dispositivo — conecte-a aqui para enviar' },
  tcLinkFailedMsg: { ru: 'Не удалось сохранить кошелёк — попробуйте ещё раз', en: 'Could not save the wallet — please try again', uk: 'Не вдалося зберегти гаманець — спробуйте ще раз', es: 'No se pudo guardar la billetera: inténtalo de nuevo', tr: 'Cüzdan kaydedilemedi — lütfen tekrar deneyin', pt: 'Não foi possível salvar a carteira — tente novamente' },
  ...
  marketTabVolume: { ru: 'Объём', en: 'Volume', uk: 'Обсяг', es: 'Volumen', tr: 'Hacim', pt: 'Volume' },
  marketVolumeBoughtLbl: { ru: 'Куплено всего', en: 'Total bought', uk: 'Куплено всього', es: 'Total comprado', tr: 'Toplam satın alınan', pt: 'Total comprado' },
  marketVolumeSoldLbl: { ru: 'Продано всего', en: 'Total sold', uk: 'Продано всього', es: 'Total vendido', tr: 'Toplam satılan', pt: 'Total vendido' },
  marketVolumeTotalLbl: { ru: 'Общий объём', en: 'Total volume', uk: 'Загальний обсяг', es: 'Volumen total', tr: 'Toplam hacim', pt: 'Volume total' },
  marketVolumeVipHdr: { ru: 'Прогресс в VIP', en: 'VIP progress', uk: 'Прогрес у VIP', es: 'Progreso VIP', tr: 'VIP ilerlemesi', pt: 'Progresso VIP' },
  ...
  shopTabPets: { ru: 'Допы', en: 'Extras', uk: 'Додатки', es: 'Extras', tr: 'Ekstralar', pt: 'Extras' },
  ...
  disassembleTabLbl: { ru: 'Разбор', en: 'Disassembly', uk: 'Розбір', es: 'Desmontaje', tr: 'Sökme', pt: 'Desmontagem' },
  disassembleHdr: { ru: 'Разбор предметов на Либерти:', en: 'Disassemble items for Liberty:', uk: 'Розбір предметів на Ліберті:', es: 'Desmontar objetos por Liberty:', tr: 'Eşyaları Liberty için sök:', pt: 'Desmontar itens por Liberty:' },
  disassembleRangeFmt: { ru: '{r} — {min}-{max} Либерти', en: '{r} — {min}-{max} Liberty', uk: '{r} — {min}-{max} Ліберті', es: '{r} — {min}-{max} Liberty', tr: '{r} — {min}-{max} Liberty', pt: '{r} — {min}-{max} Liberty' },
  disassembleBtnFmt: { ru: 'Разобрать ({min}-{max})', en: 'Disassemble ({min}-{max})', uk: 'Розібрати ({min}-{max})', es: 'Desmontar ({min}-{max})', tr: 'Sök ({min}-{max})', pt: 'Desmontar ({min}-{max})' },
  disassembleEmptyLbl: { ru: 'Нет предметов, которые можно разобрать', en: 'No items available to disassemble', uk: 'Немає предметів для розбору', es: 'No hay objetos para desmontar', tr: 'Sökülecek eşya yok', pt: 'Nenhum item para desmontar' },
  disassembleConfirmFmt: { ru: 'Разобрать «{name}» за {min}-{max} Либерти? Отменить будет нельзя.', en: 'Disassemble "{name}" for {min}-{max} Liberty? This cannot be undone.', uk: 'Розібрати «{name}» за {min}-{max} Ліберті? Скасувати не вийде.', es: '¿Desmontar "{name}" por {min}-{max} Liberty? No se puede deshacer.', tr: '"{name}" {min}-{max} Liberty için sökülsün mü? Geri alınamaz.', pt: 'Desmontar "{name}" por {min}-{max} Liberty? Não dá para desfazer.' },
