...
const I18N_UI = {
  ...
  farm2ZoneDropHdr: { ru: 'Падает с любого монстра зоны', en: 'Drops from any monster in the zone', uk: 'Падає з будь-якого монстра зони', es: 'Cae de cualquier monstruo de la zona', tr: 'Bölgedeki herhangi bir canavardan düşer', pt: 'Cai de qualquer monstro da zona' },
  farm2BestiaryHdr: { ru: 'С кого что падает', en: 'Which monster drops what', uk: 'З кого що падає', es: 'Qué suelta cada monstruo', tr: 'Hangi canavardan ne düşer', pt: 'O que cai de cada monstro' },
  farm2BestiaryHint: { ru: 'Снаряжение и книги поделены между видами: шанс у всех одинаковый, но каждый вид роняет свой набор. Уровень у каждого монстра свой, {a}-{b} — здесь показан средний.', en: 'Gear and books are split between species: the chance is the same for all of them, but each species drops its own set. Each monster rolls its own level, {a}-{b} — shown here is the average.', uk: 'Спорядження та книги поділені між видами: шанс в усіх однаковий, але кожен вид роняє свій набір. Рівень у кожного монстра свій, {a}-{b} — тут показано середній.', es: 'El equipo y los libros están repartidos entre las especies: la probabilidad es la misma para todas, pero cada especie suelta su propio conjunto. Cada monstruo tiene su nivel, {a}-{b} — aquí se muestra el promedio.', tr: 'Ekipman ve kitaplar türler arasında paylaştırılmıştır: şans hepsinde aynıdır ama her tür kendi setini düşürür. Her canavarın kendi seviyesi var, {a}-{b} — burada ortalama gösteriliyor.', pt: 'Equipamento e livros são divididos entre as espécies: a chance é a mesma para todas, mas cada espécie solta o seu próprio conjunto. Cada monstro sorteia o seu nível, {a}-{b} — aqui é mostrada a média.' },
  farm2LevelRangeFmt: { ru: 'Уровень {a}-{b}', en: 'Level {a}-{b}', uk: 'Рівень {a}-{b}', es: 'Nivel {a}-{b}', tr: 'Seviye {a}-{b}', pt: 'Nível {a}-{b}' },
  farm2SkillBooksHdr: { ru: 'Книги 1-й профессии', en: '1st profession books', uk: 'Книги 1-ї професії', es: 'Libros de 1.ª profesión', tr: '1. meslek kitapları', pt: 'Livros da 1.ª profissão' },
  farm2AdvBooksHdr: { ru: 'Книги 2-й профессии', en: '2nd profession books', uk: 'Книги 2-ї професії', es: 'Libros de 2.ª profesión', tr: '2. meslek kitapları', pt: 'Livros da 2.ª profissão' },
  farm2PassiveBooksHdr: { ru: 'Книги пассивных навыков', en: 'Passive skill books', uk: 'Книги пасивних навичок', es: 'Libros de habilidades pasivas', tr: 'Pasif yetenek kitapları', pt: 'Livros de habilidades passivas' },
