...
const I18N_UI = {
  ...
  eventSubTournament:   { ru: 'Турнир на 16 участников, на вылет', en: '16-player knockout tournament', uk: 'Турнір на 16 учасників, на виліт', es: 'Torneo de 16 participantes, eliminación directa', tr: '16 kişilik eleme turnuvası', pt: 'Torneio de 16 participantes, eliminatória' },
  ...
  trRule1:              { ru: 'Регистрация — по четвергам и воскресеньям в 23:00 по Москве, ровно 16 участников', en: 'Registration — Thursdays and Sundays at 23:00 Moscow time, exactly 16 participants', uk: 'Реєстрація — по четвергах і неділях о 23:00 за Москвою, рівно 16 учасників', es: 'Inscripción — jueves y domingos a las 23:00 (hora de Moscú), exactamente 16 participantes', tr: 'Kayıt — Perşembe ve Pazar günleri 23:00 Moskova saatiyle, tam 16 katılımcı', pt: 'Inscrição — quintas e domingos às 23h00 (horário de Moscou), exatamente 16 participantes' },
  trRule2:              { ru: 'Наберётся 16 человек — сетка стартует сразу, не дожидаясь конца окна', en: 'Once 16 people sign up, the bracket starts immediately, without waiting for the window to end', uk: 'Щойно набереться 16 людей — сітка стартує одразу, не чекаючи кінця вікна', es: 'En cuanto se inscriban 16 personas, el cuadro empieza de inmediato, sin esperar a que termine la ventana', tr: '16 kişi toplanınca kura beklemeden hemen başlar', pt: 'Assim que 16 pessoas se inscreverem, a chave começa imediatamente, sem esperar o fim da janela' },
