...
// База — плитка храма, первая локация — плиты собора (как в Diablo),
...
const _FLOOR_IMG = {
  ...
  // Первая локация (левый рукав) — плиты собора в духе Diablo: крупные
  // серо-бурые каменные плиты с тёмными швами (ambientCG Tiles098).
