...
// База — плитка храма, первая локация — плиты подземелья (как в Diablo Immortal),
// фарм-зоны — раскалённая лава. Фото-материалы
// ambientCG (Tiles093, Tiles098, Lava002; CC0 — можно без указания автора), ужаты до
...
const _FLOOR_IMG = {
  ...
  // Первая локация (левый рукав) — плиты подземелья в духе Diablo Immortal:
  // крупные объёмные плиты с фаской, у каждой свой тон, грязь в швах. Это
  // ambientCG Tiles098, в который заранее запечён свет по карте нормалей и AO
  // (свет сверху-слева), так что рельеф виден без освещения в игре.
  cathedral: { src: '/images/floor/cathedral.jpg', px: 320, wallBase: '#3a3128', brick: [64, 54, 44] },
};
