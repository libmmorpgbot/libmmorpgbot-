...
// стикер едет вместе с игроком; ушёл владелец — стикер снимается. Сама
// анимация — внутри картинки, сверху лишь появление с перелётом, лёгкий
// подъём и исчезновение.
const _STK_SIZE = 44, _STK_ABOVE = 92;
