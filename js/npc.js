...
// ── Крылья: своя модалка ────────────────────────────────────────────────────
// Отличие от классовых вещей в одном, но важном: там из классовых вещей всех
// классов (семи — pool.length в openClassGearCraftModal ниже считает их сам,
// ни здесь, ни там число не захардкожено) приходит СЛУЧАЙНАЯ, а здесь предмет
// ровно один и известен до нажатия. Показывать «один случайный из N» там, где
// случайности нет, значило бы пугать игрока на ровном месте.
