...
module.exports = [
  ...
  'js/hudart.js',
  // Код, который ЧИТАЕТ эту таблицу. Отдельным файлом, потому что hudart.js
  // перезаписывается генератором целиком: дописанное в его конец стирается
  // первым же прогоном конвейера — так и произошло.
  'js/hud.js',
  'js/utils.js',
  'js/state.js',
  'js/icons.js',
